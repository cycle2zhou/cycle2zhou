...
- 🔭 I'm **Cycle**, 一个 java coder
- 🏢 专注于 Java 生态，深耕大数据与数据平台领域
- 🔧 参与开源：Spring AI、JetCache、Hutool、MyBatis-Flex 等
- 📊 大数据经验：Flink / SeaTunnel / DataX / Iceberg / Hive
- 🏗️ 微服务治理：Nacos / Leaf 分布式 ID / 调度引擎 / 数据同步
- 📦 **12** repos · **77** stars · **43** followers
...
| ------------------- | ------------------------------------ | ------------------ | ----------------------------------------------------------- |
| [**shell-tools**](https://github.com/cycle2zhou/shell-tools)       | 一些 shell 工具脚本                  | Shell              | ![Stars](https://img.shields.io/github/stars/cycle2zhou/shell-tools?style=flat) |
| [**db-assistant-java**](https://github.com/cycle2zhou/db-assistant-java) | AI Agent 数据库探索技能（零依赖JDBC） | Java               | ![Stars](https://img.shields.io/github/stars/cycle2zhou/db-assistant-java?style=flat) |
| [**Spring Boot Enhance**](https://github.com/cycle2zhou)  | Spring Boot 增强组件                 | Java, Spring       | —                                                           |
| [**jetcache**](https://github.com/alibaba/jetcache) (fork)         | alibaba JetCache — Java 缓存框架     | Java               | —                                                           |
| [**spring-ai**](https://github.com/spring-projects/spring-ai) (fork) | Spring AI — AI 工程应用框架          | Java               | —                                                           |
| [**nacos**](https://github.com/alibaba/nacos) (fork)               | alibaba Nacos — 动态服务发现与配置   | Java               | —                                                           |
| [**Leaf**](https://github.com/Meituan-Dianping/Leaf) (fork)        | 美团 Leaf — 分布式 ID 生成服务       | Java               | —                                                           |
